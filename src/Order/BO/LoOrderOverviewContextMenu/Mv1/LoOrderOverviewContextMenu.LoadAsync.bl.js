...
if ((phase != "Initial" && phase != "HoldBack") || (mobilityRelevant === "0") || (sdoSubtype==="Delivery" && clbMainPKey != callPKey) || 
    (sdoSubtype==="Delivery" && bCallIsReadOnly) || !isResponsible || syncStatus === BLConstants.Order.NOT_SYNCABLE || (callStatus === "Planned" && isDSDMode)){
  enableCancel = "0";
}
...
if (syncStatus === BLConstants.Order.NOT_SYNCABLE && orderId.startsWith("Local_")){
  enableDelete = "1";
         ...
         (sdoSubtype==="Delivery" && bCallIsReadOnly) || !isResponsible || (syncStatus === BLConstants.Order.NOT_SYNCABLE && !orderId.startsWith("Local_") || (callStatus === "Planned" && isDSDMode))){
  enableDelete = "0";
}

if ((mobilityRelevant === "0") || (sdoSubtype==="Delivery") || ((callStatus === "Planned" || callStatus === "Completed") && isDSDMode) || isVisitReadOnly){
  enableCopy = "0";
}
