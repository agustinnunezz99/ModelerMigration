 ...
 * @description This method sets the EARights for the Tour Details based on the screen from which it is invoked
 */
function setEARights(invokedFrom){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
    ...
    if (tourStatus === "completed" || tourStatus === "canceled") {
      ...
      if (tourStatus === "initial" || tourStatus === "open") {
        ...
        if (invokedFrom === "ViewTourCard") {
          ...
          } else if (me.getEndTourVehicleDetailsReviewed() == 0) {
